...
int main() {
    ...
    if (firstday > 31 * 2 + 28) { deltadays = 31 * 2 + 28; summouth = 3; }     //3 проверка на апрель
    if (firstday > 31 * 2 + 28) { deltadays = 31 * 2 + 28; summouth = 4; }     //4 проверка на май
    if (firstday > 31 * 2 + 28 + 30) { deltadays = 31 * 2 + 28 + 30; summouth = 5; }       //5 проверка на июнь
    if (firstday > 31 * 3 + 28 + 30) { deltadays = 31 * 3 + 28 + 30; summouth = 6; }        //6 проверка на июль
    if (firstday > 31 * 3 + 28 + 30 * 2) { deltadays = 31 * 3 + 28 + 30 * 2; summouth = 7; }        //7 проверка на август
    if (firstday > 31 * 4 + 28 + 30 * 2) { deltadays = 31 * 4 + 28 + 30 * 2; summouth = 8; }        //8 проверка на сентябрь
    if (firstday > 31 * 5 + 28 + 30 * 2) { deltadays = 31 * 5 + 28 + 30 * 2; summouth = 9; }        //9 проверка на октябрь
    if (firstday > 31 * 5 + 28 + 30 * 3) { deltadays = 31 * 5 + 28 + 30 * 3; summouth = 10; }        //10 проверка на ноябрь
    if (firstday > 31 * 6 + 28 + 30 * 3) { deltadays = 31 * 6 + 28 + 30 * 3; summouth = 11; }        //11 проверка на декабрь
